<%@ Page Language="C#" AutoEventWireup="true" CodeFile="finance_req_decision.aspx.cs" Inherits="finance_req_decision" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>finance acknowledgement</title>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="finance_req_decision.css" />
</head>
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="title">
                <div class="img"></div>
                <div class="txt">FINANCE DEPT ACKNOWLEDGEMENT FORM</div>
            </div>
