...
<body style="height: 1200px">
    <form id="form1" runat="server">
        ...
        <div class="report" style="height:600px;">
                ...
                <asp:SqlDataSource ID="Pending_Requests" runat="server" ConnectionString="<%$ ConnectionStrings:OneStopConnectionString %>" SelectCommand="Select * from Pending_Degree_Req"></asp:SqlDataSource>
        </div>
        <div class="bottom">
