<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Director_Report_Pending.aspx.cs" Inherits="Director_Report_Pending" %>
...
<body style="height: 1200px">
    <form id="form1" runat="server">
        ...
        <div class="report" style="height:600px;">
                ...
                <asp:SqlDataSource ID="Pending_Requests" runat="server" ConnectionString="<%$ ConnectionStrings:OneStopConnectionString %>" SelectCommand="select a.ReqID,a.Reg_date,b.RollNo,b.Major,b.Degree_type,b.Year from Pending_Degree_Req a inner join Degree_Issue_Req b on a.ReqID=b.ReqID "></asp:SqlDataSource>
        </div>
        <div class="bottom">
