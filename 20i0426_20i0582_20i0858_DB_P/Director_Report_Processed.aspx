<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Director_Report_Processed.aspx.cs" Inherits="Director_Report_Processed" %>
...
<body style="height: 1200px">
    <form id="form1" runat="server">
        <div class="top" style="height: 400px;">
            <div class="logo"></div>
            <h1>VIEWING PROCESSED REQUESTS</h1>
        </div>
        <div class="report" style="height:600px;">
                <asp:GridView ID="GridView1" runat="server" CssClass="grid1" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="5px" CellPadding="7" CellSpacing="2" DataKeyNames="ReqID" DataSourceID="Processed_Request" GridLines="None" Width="700px">
                    <Columns>
